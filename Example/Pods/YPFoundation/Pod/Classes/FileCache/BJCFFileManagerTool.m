...
@implementation BJCFFileManagerTool
...
{
    NSArray *theList = [BJCFFileManagerTool filePathsWithDirPath:path];
    for (NSString *onePath in theList) {
        [BJCFFileManagerTool deleteFile:[onePath lastPathComponent] path:onePath];
    }
    return YES;
}
