...
#define BJCFHomeDir [BJCFFileManagerTool homeDir]
#define BJCFAppDir [BJCFFileManagerTool appDir]
#define BJCFDocDir [BJCFFileManagerTool docDir]
#define BJCFLibraryDir [BJCFFileManagerTool libraryDir]
#define BJCFLibPrefDir [BJCFFileManagerTool libPrefDir]
#define BJCFCachesDir [BJCFFileManagerTool cachesDir]
#define BJCFTmpDir [BJCFFileManagerTool tmpDir]

@interface BJCFFileManagerTool : NSObject
