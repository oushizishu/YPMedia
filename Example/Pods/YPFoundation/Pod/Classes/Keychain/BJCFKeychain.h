...
/**
 ...
 platform.
 */
typedef NS_ENUM(OSStatus, BJCFKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	BJCFKeychainErrorBadArguments = -1001,
};

/** SSKeychain error domain */
extern NSString *const kBJCFKeychainErrorDomain;

/** Account name. */
extern NSString *const kBJCFKeychainAccountKey;
 ...
 */
extern NSString *const kBJCFKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kBJCFKeychainClassKey;

/** Item description. */
extern NSString *const kBJCFKeychainDescriptionKey;

/** Item label. */
extern NSString *const kBJCFKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kBJCFKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kBJCFKeychainWhereKey;
 ...
 */
@interface BJCFKeychain : NSObject
