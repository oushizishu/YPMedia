...
#import <Security/Security.h>
	...
	#define BJCFKEYCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#ifdef BJCFKEYCHAIN_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, BJCFKeychainQuerySynchronizationMode) {
	BJCFKeychainQuerySynchronizationModeAny,
	BJCFKeychainQuerySynchronizationModeNo,
	BJCFKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface BJCFKeychainQuery : NSObject
...
@property (nonatomic) BJCFKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 BJCFKEYCHAIN_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
